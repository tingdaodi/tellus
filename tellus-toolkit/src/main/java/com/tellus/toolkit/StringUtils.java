...
public final class StringUtils {
    ...
    public static String sqlArgsFill(String content, Object... args) {
        if (StringUtils.isNotBlank(content) && ArrayUtil.isNotEmpty(args)) {
    ...
    public static String removeIsPrefixIfBoolean(String propertyName, Class<?> propertyType) {
        if (ClassKit.isBoolean(propertyType) && propertyName.startsWith(IS)) {
     ...
     * @return ignore
     * @deprecated 3.3.0 {@link ClassKit#isBoolean(Class)}
     */
    @Deprecated
