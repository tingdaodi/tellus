...
public class ResourcesSerializationExclusionStrategy extends AbstractResourcesExclusionStrategy {
    // ~ Constructors
    // ========================================================================================================

    public ResourcesSerializationExclusionStrategy(String ignoreUrls, String servletPath) {
    ...
    protected boolean isExpose(FieldAttributes f) {
        ...
        return null != exposeClass && exposeClass.serialize();
    }
