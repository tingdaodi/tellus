...
CREATE TABLE T_USER(
    ...
    GENDER INT   DEFAULT 1 COMMENT '性别 1-男，2-女；默认：1' ,
    USER_TYPE INT   DEFAULT 1 COMMENT '用户类型 1-内部用户，2-外部用户；默认：1' ,
    STATUS INT   DEFAULT 1 COMMENT '状态 1-正常，2-禁用；默认：1' ,
    ...
    LANGUAGE INT    COMMENT '使用语言 使用语言' ,
    ...
    UPDATED_AT DATETIME    COMMENT '更新时间 更新时间' ,
    DELETED INT   DEFAULT 0 COMMENT '逻辑删除 0-未删除，1-已删除；默认：0' ,
    PRIMARY KEY (ID)
) COMMENT = '用户表 用户信息';;
...
CREATE TABLE T_GROUP(
    ...
    ENABLED VARCHAR(32)   DEFAULT 1 COMMENT '是否启用 0-未启用，1-启用' ,
...
ALTER TABLE T_GROUP COMMENT '组织表';;
DROP TABLE T_FIELD;;/*SkipError*/
CREATE TABLE T_FIELD(
    ID INT NOT NULL   COMMENT '主键 主键' ,
    RESOURCE_ID VARCHAR(32) NOT NULL   COMMENT '所属资源ID 所属资源ID' ,
    METHOD VARCHAR(32) NOT NULL   COMMENT '出/入参 1-入参，2-回参' ,
...
CREATE TABLE T_RELATION(
    TYPE INT NOT NULL   COMMENT '关系类型 1-用户，2-组织，3-角色，4-菜单' ,
...
ALTER TABLE T_RELATION COMMENT '层级关系表';;
...
CREATE TABLE T_PLATFORM(
    ...
    ENABLED INT   DEFAULT 1 COMMENT '是否启用 0-未启用，1-已启用' ,
    CREATOR VARCHAR(128) NOT NULL   COMMENT '创建人 创建人' ,
    CREATED_AT DATETIME NOT NULL   COMMENT '创建时间 创建时间' ,
    UPDATER VARCHAR(128)    COMMENT '更新人 更新人' ,
    UPDATED_AT DATETIME    COMMENT '更新时间 更新时间' ,
...
ALTER TABLE T_PLATFORM COMMENT '平台信息表';;
...
CREATE TABLE T_SYS_PROPERTIES(
    ...
    ENABLED VARCHAR(32)   DEFAULT 1 COMMENT '是否启用 0-未启用，1-已启用' ,
    REMARK VARCHAR(512)    COMMENT '备注 备注' ,
    CREATOR VARCHAR(128) NOT NULL   COMMENT '创建人 创建人' ,
    CREATED_AT DATETIME NOT NULL   COMMENT '创建时间 创建时间' ,
    UPDATED_BY VARCHAR(128)    COMMENT '更新人 更新人' ,
    UPDATED_AT DATETIME    COMMENT '更新时间 更新时间' ,
    PRIMARY KEY (ID)
) COMMENT = '系统配置表 系统运行依赖配置';;

ALTER TABLE T_SYS_PROPERTIES COMMENT '系统配置表';;
...
CREATE TABLE T_LOGIN_LOG(
    ...
    CLIENT_HOST VARCHAR(512) NOT NULL   COMMENT '客户端IP/HOST 客户端IP/HOST' ,
    ...
    SICCESSFUL INT NOT NULL   COMMENT '是否成功 是否成功' ,
    PRIMARY KEY (ID)
...
CREATE TABLE T_OPERATION_LOG(
    ...
    OPERATE_TYPE INT NOT NULL   COMMENT '操作类型 1-查询，2-更新，3-新建，4-删除，5-逻辑删除' ,
    ...
    SUCCESSFUL INT   DEFAULT 1 COMMENT '是否成功 0-失败，1-成功' ,
    ...
    REQUEST_METHOD INT    COMMENT '请求方式 :GET,HEAD,POST,PUT,PATCH,DELETE,OPTIONS,TRACE' ,
    REMARK VARCHAR(512)    COMMENT '备注 备注' ,
    PRIMARY KEY (ID)
...
ALTER TABLE T_GROUP_USER COMMENT '组织用户表';;
...
ALTER TABLE T_GROUP_ROLE COMMENT '组织角色表';;
...
ALTER TABLE T_ROLE_RESOURCE COMMENT '角色资源表';;
DROP TABLE T_ROLE_FIELD;;/*SkipError*/
CREATE TABLE T_ROLE_FIELD(
    ROLE_ID INT NOT NULL   COMMENT '角色ID 角色ID' ,
    FIELD_ID INT NOT NULL   COMMENT '字段ID 字段ID' ,
    DISPLAY_MODE INT NOT NULL  DEFAULT 1 COMMENT '显示模式 默认：1；1-全显示，2-半显示，3-隐藏' ,
    PRIMARY KEY (ROLE_ID,FIELD_ID)
) COMMENT = '角色字段表 角色与字段关系';;

ALTER TABLE T_ROLE_FIELD COMMENT '角色字段表';;
